...
RegisterServerEvent("colocar-uniforme:sucata")
AddEventHandler("colocar-uniforme:sucata",function()
	local user_id = vRP.getUserId(source)
	local custom = roupas
	if custom then
...
RegisterServerEvent("tirar-uniforme:sucata")
AddEventHandler("tirar-uniforme:sucata",function()
	local user_id = vRP.getUserId(source)
