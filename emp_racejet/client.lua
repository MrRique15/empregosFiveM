...
emP = Tunnel.getInterface("emp_racejet")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = false
...
local racepoint = 1
local racepos = 0
local CoordenadaX = -1281.95           --- -1277.1, -2032.38, 2.31
local CoordenadaY = -2026.53         --- -1281.95,-2026.53,1.15
local CoordenadaZ = 1.15
...
local races = {
	[1] = {
		['time'] = 225,
		[1] = { ['x'] = -1301.87, ['y'] = -1828.59, ['z'] = -0.65 }, -- 255M
		[2] = { ['x'] = -1600.51, ['y'] = -1548.34, ['z'] = 0.15 }, --415M
		[3] = { ['x'] = -1807.97, ['y'] = -1241.89, ['z'] = -0.26 }, -- 411M
		--[4] = { ['x'] = -2140.71, ['y'] = -1143.04, ['z'] = 0 }, -- 547M
		--[5] = { ['x'] = -2837.72, ['y'] = 2378.55, ['z'] =  0 }, -- 534M
		--[4] = { ['x'] = -2010.46, ['y'] = -1052.73, ['z'] = 0.56 }, --693M
		[4] = { ['x'] = -2146.5, ['y'] = -717.94, ['z'] = 0.19 }, -- 1.02M
		[5] = { ['x'] = -2242.29, ['y'] = -607.08, ['z'] = -0.14 }, -- 355M
		[6] = { ['x'] = -2526.11, ['y'] = -364.86, ['z'] = 0.68 }, -- 260M
		[7] = { ['x'] = -2947.91, ['y'] = -86.41, ['z'] = 0.54 }, -- 442M
		[8] = { ['x'] = -3200.01, ['y'] = 337.77, ['z'] = 0.61 }, -- 421M
		[9] = { ['x'] = -3343.69, ['y'] = 972.73, ['z'] = 0.52 }, -- 212M
		[10] = { ['x'] = -3428.13, ['y'] = 982.15, ['z'] = -0.22 }, --532M
		[11] = { ['x'] = -3298.92, ['y'] = 1274.1, ['z'] = 0.01 }, --415M
		[12] = { ['x'] = -3078.31, ['y'] = 1522.52, ['z'] = 0.67 }, --835M
		[13] = { ['x'] = -3178.71, ['y'] = 1813.88, ['z'] = 0.11 }, --450M
		[14] = { ['x'] = -3070.77, ['y'] = 2209.22, ['z'] = 0.15 }, -- 735M
		[15] = { ['x'] = -2837.72, ['y'] = 2378.55, ['z'] = -0.23 } -- 255M
	},
	[2] = {
		['time'] = 280,
		[1] = { ['x'] = -1443.74, ['y'] = -2128.45, ['z'] = 0.12 },
		[2] = { ['x'] = -1671.44, ['y'] = -2346.89, ['z'] = 1.79 }, 
		[3] = { ['x'] = -1901.48, ['y'] = -2707.79, ['z'] = -1.06 },
		[4] = { ['x'] = -2007.2, ['y'] = -3154.42, ['z'] = 0.12 },
		[5] = { ['x'] = -1571.43, ['y'] = -3443.06, ['z'] = 0.08 },
		[6] = { ['x'] = -1093.11, ['y'] = -3574.51, ['z'] = 0.61 },
		[7] = { ['x'] = -715.49, ['y'] = -3254.36, ['z'] = -0.37 },
		--[8] = { ['x'] = -681.24, ['y'] = -3297.97, ['z'] = 0.49 },
		--[9] = { ['x'] = -740.13, ['y'] = -3489.6, ['z'] = 0.79 },   
		[8] = { ['x'] = -803.71, ['y'] = -3000.18, ['z'] = 1.02 },
		[9] = { ['x'] = -604.69, ['y'] = -2487.33, ['z'] = 0.14 },
		[10] = { ['x'] = -488.42, ['y'] = -2260.48, ['z'] = -0.06 },
		[11] = { ['x'] = -368.88, ['y'] = -2239.54, ['z'] = -0.06 },
		[12] = { ['x'] = 155.09, ['y'] = -2325.05, ['z'] = -1.1 },
		[13] = { ['x'] = 395.04, ['y'] = -2497.3, ['z'] = 0.21 },
		[14] = { ['x'] = 338.44, ['y'] = -2885.99, ['z'] = 0.3 },
		[15] = { ['x'] = 92.57, ['y'] = -3318.25, ['z'] = 0.21 },
		[16] = { ['x'] = 162.11, ['y'] = -2690.4, ['z'] = -0.32 }
	},
	[3] = {
		['time'] = 160,
...
Citizen.CreateThread(function()
	while true do
		...
		TriggerServerEvent('salariocorrida:pagamento')
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- STARTRACES
	...
	while true do
		...
		if not inrace then
			...
			if distance <= 50.0 then
				timeDistance = 5
				-- 
				if IsEntityAVehicle(vehicle) and GetVehicleClass(vehicle) == 14 and GetPedInVehicleSeat(vehicle,-1) == ped then
					DrawMarker(27,CoordenadaX,CoordenadaY,CoordenadaZ+1.60,0,0,0,0,0,0,10.0,10.0,1.0,0,116,137,50,0,0,0,0)
					if distance <= 7.9 then
						drawTxt("PRESSIONE  ~p~E~w~  PARA INICIAR A CORRIDA",4,0.5,0.93,0.50,255,255,255,180)
						if IsControlJustPressed(0,38) then --and emP.checkPermission() then
		...
		if inrace then
			...
			if distance <= 100.0 then
				--if IsEntityAVehicle(vehicle) and GetVehicleClass(vehicle) ~= 8 then
					DrawMarker(1,races[racepoint][racepos].x,races[racepoint][racepos].y,races[racepoint][racepos].z+1,0,0,0,0,0,0,12.0,12.0,8.0,255,255,255,25,0,0,0,0)
					DrawMarker(22,races[racepoint][racepos].x,races[racepoint][racepos].y,races[racepoint][racepos].z+1,0,0,0,0.0,0,0,3.0,3.0,2.0,148,27,150,100,1,0,0,1)
					if distance <= 15.1 then
						...
						if racepos == #races[racepoint] then
							...
							emP.registerRecord(racepoint, timerecord)
						else
							racepos = racepos + 1
							CriandoBlip(races,racepoint,racepos)
						end
...
Citizen.CreateThread(function()
	while true do
		...
		if inrace and timerace > 0 then
			timerecord = timerecord + 1
			--drawTxt("RESTAM ~g~"..timerecord.." SEGUNDOS ~w~",1,0.5,0.87,0.45,255,255,255,100)
			--drawTxt("Tempo: " ..  timerecord .. "s",1,0.5,0.87,0.50,255,255,255,180)
		end
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
