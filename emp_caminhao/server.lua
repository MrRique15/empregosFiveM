...
RegisterServerEvent("colocar-uniforme:caminhaonovo")
AddEventHandler("colocar-uniforme:caminhaonovo",function()
	local user_id = vRP.getUserId(source)
	local custom = roupas
	if custom then
...
RegisterServerEvent("tirar-uniforme:caminhaonovo")
AddEventHandler("tirar-uniforme:caminhaonovo",function()
	local user_id = vRP.getUserId(source)
