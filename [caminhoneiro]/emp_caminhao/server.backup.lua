...
local paylist = {
	["diesel"] = {
		[1] = { pay = math.random(2400,3900) },
		[2] = { pay = math.random(2400,3900) },
		[3] = { pay = math.random(2400,3900) },
		[4] = { pay = math.random(2400,3900) },
		[5] = { pay = math.random(2600,3900) },
		[6] = { pay = math.random(2400,3900) }
	},
	["gas"] = {
